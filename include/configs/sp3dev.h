...
#define CONFIG_CPU_CLK_HZ			(CONFIG_SYS_REF_CLK_HZ/3)
#else
...
#ifdef CONFIG_SPL_BUILD
#define CONFIG_PL011_CLOCK				38400000/60
#else
...
#define SYS_INIT_RAM_BASE				(0x04080000)
#define SYS_INIT_RAM_SIZE				(0x00020000)
...
#define CONFIG_SYS_TEXT_BASE	       0x04000040
...
/*#define		CONFIG_SPL_STACK				0x04080000 */
#define		CONFIG_SPL_RAM_START_ADDR		0x040A0000
#define		CONFIG_SPL_BSS_START_ADDR		0x040A0000
#define     CONFIG_SPL_BSS_MAX_SIZE			0x00020000
#define     CONFIG_SPL_DATA_START_ADDR		0x040C0000
#define		CONFIG_SYS_SPL_MALLOC_START		0x040E0000
