...
#define		CONFIG_SPL_BSS_START_ADDR		(SYS_INIT_RAM_BASE + SYS_INIT_RAM_SIZE/2)
#define		CONFIG_SYS_SPL_MALLOC_START		(CONFIG_SPL_BSS_START_ADDR + SYS_INIT_RAM_SIZE/2)
#define		CONFIG_SYS_SPL_MALLOC_SIZE		(SYS_INIT_RAM_SIZE/2)
...
#define		CONFIG_SYS_MMC_SD_FAT_BOOT_PARTITION 0
